...
OBJ = src/CharType.o src/StrFun.o src/NERDict.o src/NERFeat.o src/Vocabulary.o src/Probability.o src/Recognizer.o src/MultiPerceptron.o src/Pretreatment.o
...
test: test.o  src/Probability.o src/StrFun.o
    $(CXX) $(CFLAGS) -o test test.o src/Probability.o src/StrFun.o
    rm -rf test.o
